...
namespace Bokifa.Persistance.Migrations
{
    ...
    [Migration("20250414104203_asdnkad")]
    partial class asdnkad
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bokifa.Domain.Entities.ContactAdress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Bokifa.Domain.Entities.ContactAdress", b =>
                {
                    b.OwnsOne("Bookifa.Domain.ValueObjects.CreatedAtVO", "CreatedAt", b1 =>
                        {
                            b1.Property<Guid>("ContactAdressId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ContactAdressId");

                            b1.ToTable("ContactAdresses");

                            b1.WithOwner()
                                .HasForeignKey("ContactAdressId");
                        });
